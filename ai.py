...
class VisionThread(threading.Thread):
    ...
    def run(self):
        while True:
            ...
            print(win32gui.GetWindowDC(self.process))
            try:
...
class Overlay(QtWidgets.QWidget):
    ...
    def onClientSelected(self):
        ...
        time.sleep(3)
        self.active.clear()
        axe = self.preview.axes.add_subplot(111)
        VisionThread(fps=30, process=processID, event=self.active, figure=self.preview, axe=axe)
        time.sleep(10)
        pyplot.show()
